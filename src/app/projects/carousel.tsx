						...
						{props.projects.map((p, i) => (
							<li key={i} className="glide__slide">
								...
								<div className="lg:w-full bottom-0 my-4 flex flex-col gap-2 lg:flex-row lg:justify-between">
									<div className="w-fit flex flex-row items-center line-clamp-1 text-sm max-w-(--breakpoint-sm) lg:text-lg text-neutral-200 gap-2 rounded-full bg-neutral-800 p-2 px-4">
